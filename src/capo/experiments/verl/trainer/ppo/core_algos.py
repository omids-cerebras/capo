...
# -----------------------------------------------------------------------------
#
# We register CAPO-family advantage estimators into VERL's advantage registry.
# This enables a upstream-style "recipe" workflow where the algorithm can be
# selected via config.algorithm.adv_estimator: capo | capo_eb_lite | capo_eb.
#
# The integration is intentionally soft: if CAPO is not importable, VERL keeps
# working normally.

try:
    from capo.verl_integration.adv_estimators import (
        compute_capo_advantage as _capo_compute_capo_advantage,
    )
    from capo.verl_integration.adv_estimators import (
        compute_capo_eb_full_advantage as _capo_compute_capo_eb_full_advantage,
    )
    from capo.verl_integration.adv_estimators import (
        compute_capo_eb_lite_advantage as _capo_compute_capo_eb_lite_advantage,
    )
