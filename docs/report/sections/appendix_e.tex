...
\end{equation}
This is structurally identical to CAPO-lite with a fixed exponent \(\beta=\alpha\) and \(s\equiv 1\).

\emph{(iii) CAPO--EB-lite (length-only weighting).}
...
\emph{(iv) CAPO--EB (dependence-aware weighting).}
